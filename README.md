...
[![PyPI](https://img.shields.io/pypi/v/cognis-ewcorr.svg)](https://pypi.org/project/cognis-ewcorr/)
[![CI](https://github.com/cognis-digital/ewcorr/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/ewcorr/actions)
...
EWCORR exists for one job — correlate electronic-warfare event logs by time/frequency/bearing to cluster emitters. — and does it without a SaaS bill or heavyweight setup.
...
```bash
ewcorr --version
ewcorr scan .                      # scan the current project
ewcorr scan . --format json
ewcorr scan . --fail-on high       # non-zero exit for CI gates
ewcorr mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **ELINT correlation**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`ewcorr` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
