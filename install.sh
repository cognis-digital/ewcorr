#!/usr/bin/env sh
# Universal installer for ewcorr. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/ewcorr.git"
echo "Installing ewcorr ..."
